"""
Download the eligibilities table from BigQuery and save it to 0_data/raw_data folder.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Download BigQuery eligibilities table to 0_data/raw_data")
